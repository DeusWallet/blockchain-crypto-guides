...
Par exemple, lors de la création du portefeuille avec [Deus wallet](https://deuswallet.com) l'utilisateur obtient une seule clé privée pour 5 crypto-monnaies:
